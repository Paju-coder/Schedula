    ...
    <div className="min-h-screen bg-white text-on-background font-sans overflow-x-hidden">
      ...
      <section className="grain relative min-h-screen flex flex-col items-center justify-center text-center px-gutter pt-24 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto animate-slide-up">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-primary leading-[1.02] mb-6">
            One link.
            <br />
            <span className="text-secondary italic">Zero back-and-forth.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup" className="btn-primary text-base px-10 py-4 shadow-xl hover:shadow-2xl transition-shadow">
              Get Your Link Free
            </Link>
            <a href="#how" className="btn-outline text-base px-10 py-4">
              See How It Works
            </a>
          </div>
      ...
      <section id="features" className="py-24 px-gutter max-w-container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((f, i) => (
            <div
              key={i}
              className="card card-hover p-10 rounded-2xl group animate-fade-in"
      ...
      <section className="py-24 px-gutter">
        <div className="max-w-container mx-auto">
          <div className="bg-primary text-on-primary rounded-3xl p-16 text-center relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="border-t border-outline-variant/20 py-12 px-gutter">
